; (function (global) {
    ...
    class Item {
        constructor(context, id, color, font_size, set_self) {
            ...
            //随机生成弹幕所在的高度
            this.top = Math.floor(Math.random() * height) + "px";
            //获取弹幕区的宽度
    ...
    function change_height(new_height) {
        height = new_height;
    }

    // 兼容CommonJs规范
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = { Item, change_height }
    }

    // 兼容AMD/CMD规范
    if (typeof define === 'function') {
        define(function () {
            return { Item, change_height }
        })
    }

    // 注册全局变量，兼容直接使用script标签引入插件
    global.Item = Item;
    global.change_height = change_height;
